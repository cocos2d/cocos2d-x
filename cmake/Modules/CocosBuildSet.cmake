...
macro(CocosBuildSet)
    ...
    set(prebuilt_path_prefix $ENV{COCOS_TEMPLATES_ROOT}/../prebuilt)
    if(IS_DIRECTORY ${prebuilt_path_prefix})
        # prebuilt libs path
        set(COCOS_PREBUILT_LIBS_PATH ${prebuilt_path_prefix}/${PLATFORM_FOLDER}/${CMAKE_BUILD_TYPE})
        if(XCODE OR VS)
            set(COCOS_PREBUILT_LIBS_PATH ${prebuilt_path_prefix}/${PLATFORM_FOLDER})
        endif()
        if(ANDROID)
            set(COCOS_PREBUILT_LIBS_PATH ${prebuilt_path_prefix}/${PLATFORM_FOLDER}/${ANDROID_ABI})
        endif()
