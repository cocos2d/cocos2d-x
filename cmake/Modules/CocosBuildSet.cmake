...
macro(CocosBuildSet)
    ...
    if(XCODE OR VS)
        set(COCOS_PREBUILT_LIBS_PATH ${COCOS2DX_ROOT_PATH}/prebuilt/${PLATFORM_FOLDER})
    endif()
    if(ANDROID)
        set(COCOS_PREBUILT_LIBS_PATH ${COCOS2DX_ROOT_PATH}/prebuilt/${PLATFORM_FOLDER}/${ANDROID_ABI})
    endif()
