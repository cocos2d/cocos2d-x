...
function(cocos_find_prebuilt_libs lib_target lib_ret)
  ...
  set(search_path ${COCOS_PREBUILT_LIBS_PATH})
  if(XCODE OR VS)
    set(search_path ${COCOS_PREBUILT_LIBS_PATH}/${CMAKE_BUILD_TYPE})
  endif()
...
macro(cocos_mark_app app_name)
  ...
  if(USE_COCOS_PREBUILT_LIBS)
    ...
    #     else(DEFINED _${depend_lib}_prefix)
    ...
    #   message(STATUS "*****ANDROID OR WINDOWS: PLATFORM_SPECIFIC_LIBS:${PLATFORM_SPECIFIC_LIBS}__________")
    #   target_link_libraries(${app_name} ${PLATFORM_SPECIFIC_LIBS})
    # endif()
    foreach(common_lib ${opt_DEPEND_COMMON_LIBS})
      message(STATUS "************:use common_lib:${common_lib} :prefix ${_${depend_lib}_prefix}___________")
      cocos_use_pkg(${app_name} ${_${common_lib}_prefix})
    endforeach()

    include(CocosUseLibs)
    foreach(platform_lib ${PLATFORM_SPECIFIC_LIBS})
      target_link_libraries(${app_name} ${platform_lib})
    endforeach()
    foreach(prebuilt_lib ${PREBUILT_SPECIFIC_LIBS})
      cocos_use_pkg(${app_name} ${prebuilt_lib})
    endforeach()
  else()
    foreach(common_lib ${opt_DEPEND_COMMON_LIBS})
