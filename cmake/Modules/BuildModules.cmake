macro (BuildModules)
  ...
  if(USE_RECAST)
    if(USE_EXTERNAL_PREBUILT OR USE_EXTERNAL_SOURCES)
      ...
      if(USE_COCOS_PREBUILT)
        cocos_find_prebuilt(recast RECAST_LIBRARIES)
      else()
  ...
  # Tinyxml2 (not prebuilded, exists as source)
    if(USE_EXTERNAL_PREBUILT OR USE_EXTERNAL_SOURCES)
      ...
      if(USE_COCOS_PREBUILT)
        cocos_find_prebuilt(tinyxml2 TinyXML2_LIBRARIES)
      else()
  ...
  if(ANDROID)
    ...
    if(USE_COCOS_PREBUILT)
      cocos_find_prebuilt(pvmp3dec PVMP3DEC_LIBRARIES)
    else()
    ...
    if(USE_COCOS_PREBUILT)
      cocos_find_prebuilt(tremolo TREMOLO_LIBRARIES)
    else()
  ...
  if(USE_EXTERNAL_PREBUILT OR NOT MINGW OR USE_EXTERNAL_SOURCES)
    ...
    if(USE_COCOS_PREBUILT)
      cocos_find_prebuilt(unzip MINIZIP_LIBRARIES)
    else()
  ...
  if(USE_EXTERNAL_PREBUILT OR USE_EXTERNAL_SOURCES)
    ...
    if(USE_COCOS_PREBUILT)
      cocos_find_prebuilt(flatbuffers FLATBUFFERS_LIBRARIES)
    else()
  ...
  if(USE_EXTERNAL_PREBUILT OR USE_EXTERNAL_SOURCES)
    ...
    if(USE_COCOS_PREBUILT)
      cocos_find_prebuilt(xxhash XXHASH_LIBRARIES)
    else()
