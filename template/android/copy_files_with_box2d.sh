...
copy_src_and_jni(){
    ...
    cat $COCOS2DX_ROOT/template/android/AndroidTemplate1_box2d.mk > $APP_DIR/android/jni/helloworld/Android.mk
    cat $COCOS2DX_ROOT/template/android/Application_box2d.mk > $APP_DIR/android/jni/Application.mk
    cat $COCOS2DX_ROOT/template/android/AndroidTemplate2_box2d.mk > $APP_DIR/android/jni/Android.mk
}
...
modify_applicationdemo(){
    ...
    # add System.loadlibrary("box2d")
    sed "s/System.loadLibrary(\"cocosdenshion\")\;/System.loadLibrary(\"box2d\")\;System.loadLibrary(\"cocosdenshion\")\;/" $APP_DIR/android/src/$PACKAGE_PATH_DIR/tempfile.java > $APP_DIR/android/src/$PACKAGE_PATH_DIR/tempfile2.java 
    rm -fr $APP_DIR/android/src/org/cocos2dx/application
    rm $APP_DIR/android/src/$PACKAGE_PATH_DIR/tempfile.java
    mv $APP_DIR/android/src/$PACKAGE_PATH_DIR/tempfile2.java $APP_DIR/android/src/$PACKAGE_PATH_DIR/$APP_NAME.java
}
