...
void WebSocketTestLayer::onError(cocos2d::extension::WebSocket* ws, const cocos2d::extension::WebSocket::WS_ERROR& error)
{
...
{
    if (_wsiSendText->getReadyState() == WebSocket::WS_STATE_OPEN)
    {
...
{
    if (_wsiSendBinary->getReadyState() == WebSocket::WS_STATE_OPEN)
    {
