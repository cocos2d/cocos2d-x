...
void UILabelTest_Editor::switchLoadMethod(cocos2d::CCObject *pSender)
{
    ...
    if (item->getSelectedIndex() == 0){
        ...
        _layout = static_cast<Layout*>(GUIReader::getInstance()->widgetFromJsonFile("cocosui/UIEditorTest/UILabel_Editor/ui_label_editor_1.json"));
        ...
        _layout = static_cast<Layout*>(GUIReader::getInstance()->widgetFromBinaryFile("cocosui/UIEditorTest/UILabel_Editor/ui_label_editor_1.csb"));
        _touchGroup->addWidget(_layout);
