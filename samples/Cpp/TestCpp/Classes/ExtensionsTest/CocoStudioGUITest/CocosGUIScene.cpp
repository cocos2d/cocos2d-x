...
//    sc->setInnerContainerSize(CCSizeMake(480, 320));
    ...
    UIButton* iv = UIButton::create();
    iv->loadTextures("cocosgui/animationbuttonnormal.png",NULL,NULL);
//    sc->addChild(iv);
...
//
    ...
    UIButton* btnB = (UIButton*)(CCUIHELPER->cloneWidget(btnT));
...
//    ul->addWidget(sc);
    ...
    UIWidget* lc = CCUIHELPER->cloneWidget(l);
