...
void CocosGUITestMainLayer::menuCallback(CCObject* pSender)
{
    ...
    switch (nIndex)
    {
        ...
        case TEST_LISTVIEW:
		{
			pManager->setCurrentUISceneId(kUIListViewExTest_Vertical);
            pManager->setMinUISceneId(kUIListViewExTest_Vertical);
            pManager->setMaxUISceneId(kUIListViewExTest_Horizontal);
		}
            break;
