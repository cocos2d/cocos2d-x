...
{    
    switch (m_nCurrentUISceneId)
    {
        ...
        case kUIScrollViewTest_ScrollToPercentBothDirection_Bounce:
            ...
            /*
        case kUIScrollViewTest_TweakToPosition:
            return UIScrollViewTest_TweakToPosition::sceneWithTitle(s_testArray[m_nCurrentUISceneId]);
             */
            /*=*/
