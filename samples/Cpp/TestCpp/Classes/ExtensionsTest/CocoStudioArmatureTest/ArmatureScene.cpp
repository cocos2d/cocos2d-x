...
void TestAsynchronousLoading::onEnter()
{
    ...
    CCArmatureDataManager::sharedArmatureDataManager()->addArmatureFileInfoAsync("armature/Cowboy.csb", this, schedule_selector(TestAsynchronousLoading::dataLoaded));
