...
SpriteAnchorPoint::SpriteAnchorPoint()
{
    ...
    for(int i=0;i<3;i++) 
    {
        ...
        {
            case 0:
                sprite->setAnchorPoint( Point::ANCHOR_LOWER_LEFT );
                break;
            case 1:
                sprite->setAnchorPoint( Point::ANCHOR_MIDDLE );
                break;
            case 2:
                sprite->setAnchorPoint( Point::ANCHOR_UPPER_RIGHT );
                break;
        }
...
SpriteChildrenAnchorPoint::SpriteChildrenAnchorPoint()
{
    ...
    sprite1->setAnchorPoint( Point::ANCHOR_LOWER_LEFT );
    ...
    sprite1->setAnchorPoint( Point::ANCHOR_UPPER_RIGHT );
