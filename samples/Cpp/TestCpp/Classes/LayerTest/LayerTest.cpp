...
LayerGradient::LayerGradient()
{
    ...
    CCMenuItemToggle *item = CCMenuItemToggle::createWithCallback( CALLBACK_1(LayerGradient::toggleItem, this), item1, item2, NULL);
...
void LayerIgnoreAnchorPointPos::onEnter()
{
    ...
    CCMenuItemFont *item = CCMenuItemFont::create("Toggle ignore anchor point", CALLBACK_1(LayerIgnoreAnchorPointPos::onToggle, this));
...
void LayerIgnoreAnchorPointRot::onEnter()
{
    ...
    CCMenuItemFont *item = CCMenuItemFont::create("Toogle ignore anchor point", CALLBACK_1(LayerIgnoreAnchorPointRot::onToggle, this));
...
void LayerIgnoreAnchorPointScale::onEnter()
{
    ...
    CCMenuItemFont *item = CCMenuItemFont::create("Toogle ignore anchor point", CALLBACK_1(LayerIgnoreAnchorPointScale::onToggle, this));
