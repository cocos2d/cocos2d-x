...
{
    CCPoint visibleOrigin = ccp(0, 0);//CCEGLView::sharedOpenGLView()->getVisibleOrigin();
    CCSize visibleSize = CCDirector::sharedDirector()->getWinSize();//CCEGLView::sharedOpenGLView()->getVisibleSize();
