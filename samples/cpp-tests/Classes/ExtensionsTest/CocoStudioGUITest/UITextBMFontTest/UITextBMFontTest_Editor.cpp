...
bool UITextBMFontTest_Editor::init()
{
    ...
    {
        _layout = static_cast<Layout*>(cocostudio::GUIReader::getInstance()->widgetFromJsonFile("cocosgui/UIEditorTest/UILabelBMFont_Editor/ui_labelbmfont_editor_1.json"));
