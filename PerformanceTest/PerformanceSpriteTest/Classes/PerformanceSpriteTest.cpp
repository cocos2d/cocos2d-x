...
void SpriteMainScene::initWithSubTest(int asubtest, int nNodes)
{
    ...
    // add menu
    CCMenuItemImage *item1 = CCMenuItemImage::itemFromNormalImage("Images/b1.png", "Images/b2.png", this, menu_selector(SpriteMainScene::backCallback) );
    CCMenuItemImage *item2 = CCMenuItemImage::itemFromNormalImage("Images/r1.png", "Images/r2.png", this, menu_selector(SpriteMainScene::restartCallback) );
    CCMenuItemImage *item3 = CCMenuItemImage::itemFromNormalImage("Images/f1.png", "Images/f2.png", this, menu_selector(SpriteMainScene::nextCallback) );
...
void SpriteMainScene::restartCallback(CCObject* pSender)
{
    showCurrentTest();
}

void SpriteMainScene::nextCallback(CCObject* pSender)
{
    s_nSpriteCurCase++;
    s_nSpriteCurCase = s_nSpriteCurCase % TEST_COUNT;

    showCurrentTest();
}

void SpriteMainScene::backCallback(CCObject* pSender)
{
    s_nSpriteCurCase--;
    if( s_nSpriteCurCase < 0 )
...
void SpriteMainScene::showCurrentTest()
{
    ...
    if (pScene)
    {
        pScene->initWithSubTest(subtestNumber, quantityNodes);
