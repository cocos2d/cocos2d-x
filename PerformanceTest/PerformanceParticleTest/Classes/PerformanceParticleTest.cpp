...
void ParticleMainScene::initWithSubTest(int asubtest, int particles)
{
    ...
    // Next Prev Test
    CCMenuItemImage *item1 = CCMenuItemImage::itemFromNormalImage("Images/b1.png", "Images/b2.png", this, menu_selector(ParticleMainScene::backCallback) );
    CCMenuItemImage *item2 = CCMenuItemImage::itemFromNormalImage("Images/r1.png", "Images/r2.png", this, menu_selector(ParticleMainScene::restartCallback) );
    CCMenuItemImage *item3 = CCMenuItemImage::itemFromNormalImage("Images/f1.png", "Images/f2.png", this, menu_selector(ParticleMainScene::nextCallback) );
...
void ParticleMainScene::restartCallback(CCObject* pSender)
{
    showCurrentTest();
}

void ParticleMainScene::nextCallback(CCObject* pSender)
{
    s_nParCurIdx++;
    s_nParCurIdx = s_nParCurIdx % TEST_COUNT;

    showCurrentTest();
}

void ParticleMainScene::backCallback(CCObject* pSender)
{
    s_nParCurIdx--;
    if( s_nParCurIdx < 0 )
...
void ParticleMainScene::showCurrentTest()
{
    ...
    if (pNewScene)
    {
        pNewScene->initWithSubTest(subtestNumber, quantityParticles);
