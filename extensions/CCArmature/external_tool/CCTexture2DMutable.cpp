...
bool Texture2DMutable::initWithData(const void* data, int dataLen, Texture2DPixelFormat pixelFormat, unsigned int width, unsigned int height, const Size& size)
{
