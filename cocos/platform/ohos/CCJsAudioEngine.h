...
public:    
    ...
    static void playBackgroundMusic(std::string& audioUri, int seek, bool bLoop);
    static void playBackgroundMusic(std::string& audioUri, bool bLoop);
