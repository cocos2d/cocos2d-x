...
void PluginRender::DispatchKeyEvent(OH_NativeXComponent* component, void* window)
{
    ...
    while (!keyEventQueue_.empty()) {
        ...
        cocos2d::CCDirector::sharedDirector()->getEventDispatcher()->dispatchEvent(&event);
    }
}
...
void PluginRender::DispatchMouseWheelEvent()
{
    ...
    while (!mouseWheelEventQueue_.empty()) {
        ...
        cocos2d::CCDirector::sharedDirector()->getEventDispatcher()->dispatchEvent(&mouseWheelEvent);
    }
}
...
void PluginRender::OnShowNative() {
    ...
    cocos2d::CCDirector::sharedDirector()->getEventDispatcher()->dispatchEvent(&foregroundEvent);
    if (timerInited_) {
