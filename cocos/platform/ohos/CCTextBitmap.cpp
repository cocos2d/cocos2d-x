...
void CCTextBitmap::createCCTextBitmap(CCTextBitmap* cCTextBitmap, const char *text,  const char *pFontName, const int fontSize,
    ...
    // COLOR_FORMAT_RGBA_8888£ºEach pixel is represented by a 32-bit quantity. 8 bits indicate transparency, 8 bits indicate red, 8 bits indicate green, and 8 bits indicate blue.
