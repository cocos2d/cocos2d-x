...
ActionInterval* CCBAnimationManager::getAction(CCBKeyframe *pKeyframe0, CCBKeyframe *pKeyframe1, const std::string& propName, Node *pNode)
{
    ...
    else if (propName == "position")
    {
        ...
        CCBReader::PositionType corner = static_cast<CCBReader::PositionType>(value[2].asInt());
        CCBReader::PositionUnit xUnit = static_cast<CCBReader::PositionUnit>(value[3].asInt());
        CCBReader::PositionUnit yUnit = static_cast<CCBReader::PositionUnit>(value[4].asInt());
        
        Size containerSize = getContainerSize(pNode->getParent());
        
        Vector2 absPos = getAbsolutePosition(Vector2(x,y),
                                             xUnit, yUnit,
                                             corner,
                                             containerSize,
                                             propName);
...
void CCBAnimationManager::setAnimatedProperty(const std::string& propName, Node *pNode, const Value& value, Ref* obj, float fTweenDuration)
{
    ...
    else 
    {
        ...
        if (propName == "position")
        {
            ...
            CCBReader::PositionType corner = static_cast<CCBReader::PositionType>(valueVector[2].asInt());
            CCBReader::PositionUnit xUnit = static_cast<CCBReader::PositionUnit>(valueVector[3].asInt());
            CCBReader::PositionUnit yUnit = static_cast<CCBReader::PositionUnit>(valueVector[4].asInt());
