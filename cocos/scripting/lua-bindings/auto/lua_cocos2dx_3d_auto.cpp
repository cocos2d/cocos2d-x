...
int lua_cocos2dx_3d_TextureCube_getBackendTexture(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<cocos2d::backend::Texture>(tolua_S, "ccbakend.Texture",(cocos2d::backend::Texture*)ret);
        return 1;
    }
...
int lua_cocos2dx_3d_Mesh_setProgramState(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<cocos2d::backend::ProgramState>(tolua_S, 2, "ccbakend.ProgramState",&arg0, "cc.Mesh:setProgramState");
        if(!ok)
        {
...
int lua_cocos2dx_3d_Sprite3D_setProgramState(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<cocos2d::backend::ProgramState>(tolua_S, 2, "ccbakend.ProgramState",&arg0, "cc.Sprite3D:setProgramState");
        if(!ok)
        {
...
int lua_cocos2dx_3d_Sprite3DMaterial_createWithProgramState(lua_State* tolua_S)
{
    ...
    {
        cocos2d::backend::ProgramState* arg0;
        ok &= luaval_to_object<cocos2d::backend::ProgramState>(tolua_S, 2, "ccbakend.ProgramState",&arg0, "cc.Sprite3DMaterial:createWithProgramState");
        if(!ok)
        {
