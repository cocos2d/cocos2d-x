...
--------------------------------
-- overload function: initWithTexture(cc.Texture2D, rect_table, bool, vector2_table, size_table)
--          
...
--------------------------------
-- overload function: initWithTextureFilename(string, rect_table, bool, vector2_table, size_table)
--          
...
--------------------------------
-- overload function: create(string, rect_table, bool, vector2_table, size_table)
--          
...
--------------------------------
-- overload function: createWithTexture(cc.Texture2D, rect_table, bool, vector2_table, size_table)
--          
