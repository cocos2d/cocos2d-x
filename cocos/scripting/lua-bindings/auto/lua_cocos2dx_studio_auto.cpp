...
int lua_cocos2dx_studio_NodeReader_createNodeFromProtocolBuffers(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_NodeReader_createNodeFromProtocolBuffers'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccs.NodeReader:createNodeFromProtocolBuffers");
        if(!ok)
            return 0;
    ...
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.NodeReader:createNodeFromProtocolBuffers",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_NodeReader_createNodeFromProtocolBuffers'.",&tolua_err);
#endif
...
int lua_cocos2dx_studio_NodeReader_getProtocolBuffersPath(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::timeline::NodeReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_NodeReader_getProtocolBuffersPath'", nullptr);
        return 0;
    }
#endif
    ...
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.NodeReader:getProtocolBuffersPath",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_NodeReader_getProtocolBuffersPath'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_NodeReader_setProtocolBuffersPath(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::timeline::NodeReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_NodeReader_setProtocolBuffersPath'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccs.NodeReader:setProtocolBuffersPath");
        if(!ok)
            return 0;
        cobj->setProtocolBuffersPath(arg0);
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.NodeReader:setProtocolBuffersPath",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_NodeReader_setProtocolBuffersPath'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_NodeReader_isRecordProtocolBuffersPath(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::timeline::NodeReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_NodeReader_isRecordProtocolBuffersPath'", nullptr);
        return 0;
    }
#endif
    ...
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.NodeReader:isRecordProtocolBuffersPath",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_NodeReader_isRecordProtocolBuffersPath'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_NodeReader_setRecordProtocolBuffersPath(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::timeline::NodeReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_NodeReader_setRecordProtocolBuffersPath'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccs.NodeReader:setRecordProtocolBuffersPath");
        if(!ok)
            return 0;
        cobj->setRecordProtocolBuffersPath(arg0);
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.NodeReader:setRecordProtocolBuffersPath",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_NodeReader_setRecordProtocolBuffersPath'.",&tolua_err);
#endif
...
int lua_cocos2dx_studio_NodeReader_nodeFromProtocolBuffersFile(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::timeline::NodeReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_NodeReader_nodeFromProtocolBuffersFile'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccs.NodeReader:nodeFromProtocolBuffersFile");
        if(!ok)
            return 0;
        cocos2d::Node* ret = cobj->nodeFromProtocolBuffersFile(arg0);
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.NodeReader:nodeFromProtocolBuffersFile",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_NodeReader_nodeFromProtocolBuffersFile'.",&tolua_err);
#endif
