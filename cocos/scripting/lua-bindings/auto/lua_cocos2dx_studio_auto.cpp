...
int lua_cocos2dx_studio_ActionTimelineCache_loadActionTimelineFromXML(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::timeline::ActionTimelineCache* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ActionTimelineCache_loadActionTimelineFromXML'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<const tinyxml2::XMLElement>(tolua_S, 2, "tinyxml2.XMLElement",&arg0);
        if(!ok)
            return 0;
    ...
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ccs.ActionTimelineCache:loadActionTimelineFromXML",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ActionTimelineCache_loadActionTimelineFromXML'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_studio_ActionTimelineCache(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ActionTimelineCache");
        ...
        tolua_function(tolua_S,"loadActionTimelineFromXML",lua_cocos2dx_studio_ActionTimelineCache_loadActionTimelineFromXML);
