...
struct b2PrismaticJointDef : public b2JointDef
{
	...
	/// The coCCEventtrained angle between the bodies: body2_angle - body1_angle.
...
/// A prismatic joint. This joint provides one degree of freedom: traCCEventlation
...
protected:
	...
	b2PrismaticJoint(coCCEventt b2PrismaticJointDef* def);
...
inline float32 b2PrismaticJoint::GetMotorSpeed() coCCEventt
{
	return m_motorSpeed;
}
