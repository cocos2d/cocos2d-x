...
copy .\Res\Images\Pea.png           		D:\Work7\NEWPLUS\TDA_DATA\UserData
copy .\Res\Images\bitmapFontTest3.fnt		D:\Work7\NEWPLUS\TDA_DATA\UserData
copy .\Res\Images\bitmapFontTest3.png   D:\Work7\NEWPLUS\TDA_DATA\UserData