...
MenuLayer1::MenuLayer1()
{
	...
	CCLabelAtlas* labelAtlas = CCLabelAtlas::labelAtlasWithString("0123456789", "fps_images.png", 16, 24, '.');
	...
	CCBitmapFontAtlas* label = CCBitmapFontAtlas::bitmapFontAtlasWithString("configuration", "bitmapFontTest3.fnt");
...
MenuLayer3::MenuLayer3()
{
	...
	CCBitmapFontAtlas* label = CCBitmapFontAtlas::bitmapFontAtlasWithString("Enable AtlasItem", "bitmapFontTest3.fnt");
...
MenuLayer4::MenuLayer4()
{
	...
	CCBitmapFontAtlas *label = CCBitmapFontAtlas::bitmapFontAtlasWithString( "go back", "bitmapFontTest3.fnt" );
