...
3. Add the project 
4. Set up NDK location Eclipse->Preferences->Android->NDK
5. Right click on your project and find Android Tools->Add native support
6. Right click on your project Properties->C/C++ Build change build command to ${ProjDirPath}/build_native.py -n NDK_DEBUG=1
7. Click **Run** or **Debug** to compile C++ followed by Java and to run on connected device or emulator.
8. Now you can click Debug as -> Android Native Application 
9. If you want you cant turn code analysis to off Right click on your project Properties->C/C++ General->Code Analysis->Use project settings and uncheck "Syntax and Semantics errors"
