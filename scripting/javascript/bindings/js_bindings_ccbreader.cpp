...
void register_CCBuilderReader(JSContext *cx, JSObject *obj) {
    ...
    JS_DefineFunction(cx, jsb_CCBAnimationManager_prototype, "setAnimationCompletedCallback", js_cocos2dx_CCBAnimationManager_animationCompleteCallback, 2, JSPROP_READONLY | JSPROP_PERMANENT);
}
