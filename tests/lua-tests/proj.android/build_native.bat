...
"%ANDROID_NDK_ROOT%\ndk-build" %ANDROID_NDK_BUILD_FLAGS% NDK_DEBUG=%NDK_DEBUG% %NDK_BUILD_FLAGS% -C %APP_ANDROID_ROOT% NDK_MODULE_PATH=%APP_ANDROID_ROOT%;%QUICK_COCOS2DX_ROOT%;%COCOS2DX_ROOT%;%QUICK_COCOS2DX_ROOT%/external
