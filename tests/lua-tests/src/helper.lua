...
function TestCastScene.initWithLayer(scene)
    ...
    menu:addChild(item3)
    menu:setPosition(cc.p(0, 0))
    item1:setPosition(cc.p(origin.x + size.width / 2 - item2:getContentSize().width * 2, origin.y + size.y + item2:getContentSize().height / 2))
    item2:setPosition(cc.p(origin.x + size.width / 2, origin.y + size.y + item2:getContentSize().height / 2))
    item3:setPosition(cc.p(origin.x + size.width / 2 + item2:getContentSize().width * 2, origin.y + size.y + item2:getContentSize().height / 2))
