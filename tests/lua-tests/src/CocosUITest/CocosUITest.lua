...
function UIScene:init()
    ...
    self._widget = ccui.Layout:create()
    self._widget:setAnchorPoint(cc.p(0,0))
    self._widget:setPosition(cc.p(0,0))
    self._widget:setName("root_Panel")
    self._widget:setTag(81)
    self._widget:setContentSize(cc.size(480,320))
    self._widget:setBackGroundImage("cocosui/UITest/background.png")
    ...
    backgroundPanel:setAnchorPoint(cc.p(0,0))
    backgroundPanel:setPosition(cc.p(90, 75))
    self._widget:addChild(backgroundPanel)

    self._sceneTitle = ccui.Text:create("", "fonts/arial.ttf", 20)
    self._sceneTitle:setPosition(cc.p(240,307))
    self._widget:addChild(self._sceneTitle)
    ...
    local left_button = ccui.Button:create("cocosui/UITest/b1.png", "cocosui/UITest/b2.png")
    left_button:setPosition(cc.p(142,23))
    self._widget:addChild(left_button)
    ...
    local middle_button = ccui.Button:create("cocosui/UITest/r1.png", "cocosui/UITest/r2.png")
    middle_button:setPosition(cc.p(240,23))
    self._widget:addChild(middle_button)
    ...
    local right_button= ccui.Button:create("cocosui/UITest/f1.png", "cocosui/UITest/f2.png")
    right_button:setPosition(cc.p(338,23))
    self._widget:addChild(right_button)
