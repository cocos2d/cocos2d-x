...
function BillBoardTest:addNewBillBoradWithCoords(p)
    ...
    for i= 1, 10 do
        ...
        billborad:setBlendFunc(cc.blendFunc(gl.SRC_ALPHA , gl.ONE_MINUS_SRC_ALPHA))
...
function BillBoardTest:addNewAniBillBoradWithCoords(p)
    for i = 1, 10 do
        ...
        billboradAni:setBlendFunc(cc.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA))
...
function BillBoardTest:init()
    ...
    for i= 1, 4 do
        ...
        billboard:setBlendFunc(cc.blendFunc(gl.SRC_ALPHA , gl.ONE_MINUS_SRC_ALPHA))
