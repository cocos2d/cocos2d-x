...
bool QuestionContainerSprite::init()
{
    if (Sprite::init())
    {
        ...
        layer->setPosition(Vector2(-width / 2, -height / 2));
        ...
        corner->setPosition(Vector2(-(width / 2 + corner->getContentSize().width / 2), -(height / 2 + corner->getContentSize().height / 2)));
        addChild(corner);

        auto corner2 = Sprite::create("Images/bugs/corner.png");
        corner2->setPosition(Vector2(-corner->getPosition().x, corner->getPosition().y));
        corner2->setFlippedX(true);
        addChild(corner2);

        auto corner3 = Sprite::create("Images/bugs/corner.png");
        corner3->setPosition(Vector2(corner->getPosition().x, -corner->getPosition().y));
        corner3->setFlippedY(true);
        addChild(corner3);

        auto corner4 = Sprite::create("Images/bugs/corner.png");
        corner4->setPosition(Vector2(corner2->getPosition().x, -corner2->getPosition().y));
        ...
        edge->setPosition(Vector2(corner->getPosition().x + (corner->getContentSize().width / 2) + (width / 2), corner->getPosition().y));
        addChild(edge);
        
        auto edge2 = Sprite::create("Images/bugs/edge.png");
        edge2->setScaleX(width);
        edge2->setPosition(Vector2(corner->getPosition().x + (corner->getContentSize().width / 2) + (width / 2), -corner->getPosition().y));
        ...
        edge3->setPosition(Vector2(corner->getPosition().x, corner->getPosition().y + (corner->getContentSize().height / 2) + (height / 2)));
        addChild(edge3);

        auto edge4 = Sprite::create("Images/bugs/edge.png");
        edge4->setRotation(270);
        edge4->setScaleX(height);
        edge4->setPosition(Vector2(-corner->getPosition().x, corner->getPosition().y + (corner->getContentSize().height / 2) + (height / 2)));
        addChild(edge4);
