...
{
    auto map = TMXTiledMap2::create("TileMaps/orthogonal-test3.tmx");
    addChild(map, 0, kTagTileMap);
...
void TMXOrthoTest4New::removeSprite(float dt)
{
    ...
    auto map = static_cast<TMXTiledMap2*>( getChildByTag(kTagTileMap) );
    auto layer = map->getLayer("Layer 0");
    auto s = layer->getLayerSize();
...
{    
    auto map = (TMXTiledMap2*)getChildByTag(kTagTileMap);
    auto layer = (TMXLayer2*)map->getChildByTag(0);
...
TMXHexTestNew::TMXHexTestNew()
{
    ...
    auto map = TMXTiledMap2::create("TileMaps/hexa-test.tmx");
    addChild(map, 0, kTagTileMap);
...
TMXIsoTest2New::TMXIsoTest2New()
{
    ...
    auto map = TMXTiledMap2::create("TileMaps/iso-test2.tmx");
    addChild(map, 0, kTagTileMap);    
...
TMXUncompressedTestNew::TMXUncompressedTestNew()
{
    ...
    auto map = TMXTiledMap2::create("TileMaps/iso-test2-uncompressed.tmx");
    addChild(map, 0, kTagTileMap);    
...
//        layer= static_cast<TMXLayer2*>(node);
//        layer->releaseMap();
//    }
...
{
    auto map = TMXTiledMap2::create("TileMaps/orthogonal-test5.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/ortho-objects.tmx");
...
{
    auto map = TMXTiledMap2::create("TileMaps/iso-test-objectgroup.tmx");
    addChild(map, -1, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/iso-test-vertexz.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/orthogonal-test-vertexz.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/iso-test-movelayer.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/orthogonal-test-movelayer.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/ortho-tile-property.tmx");
    addChild(map ,0 ,kTagTileMap);
...
TMXOrthoFromXMLTestNew::TMXOrthoFromXMLTestNew()
{
    ...
    auto map = TMXTiledMap2::createWithXML(str->getCString() ,resources.c_str());
    addChild(map, 0, kTagTileMap);
...
TMXOrthoXMLFormatTestNew::TMXOrthoXMLFormatTestNew()
{
    ...
    auto map = TMXTiledMap2::create("TileMaps/xml-test.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/orthogonal-test6.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/iso-test-bug787.tmx");
    addChild(map, 0, kTagTileMap);
...
{
    auto map = TMXTiledMap2::create("TileMaps/test-object-layer.tmx");
    addChild(map, -1, kTagTileMap);
