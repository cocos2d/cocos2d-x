...
void UISliderTest_Editor::switchLoadMethod(cocos2d::Ref *pSender)
{
    ...
    switch (item->getSelectedIndex())
    {
        ...
        case 2:
        {
            ...
            // before
//            Node* node = cocostudio::timeline::NodeReader::getInstance()->createNode("cocosui/UIEditorTest/UISlider_Editor/crossplatform_UISlider_Editor_1.ExportJson");
            /**/
        ...
        case 3:
        {
            ...
            // before
//            Node* node = cocostudio::timeline::NodeReader::getInstance()->createNodeFromProtocolBuffers("cocosui/UIEditorTest/UISlider_Editor/crossplatform_UISlider_Editor_1.csb");
            /**/
            Node* child = node->getChildByTag(5);
            child->removeFromParent();
            _layout = static_cast<Layout*>(child);
