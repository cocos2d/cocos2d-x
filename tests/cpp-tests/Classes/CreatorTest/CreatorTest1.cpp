...
Node* CreatorTest1_create()
{
    ...
    // New node
    auto tmxtiledmap_1 = TMXTiledMap::create("creator_assets/iso-test.tmx");
    tmxtiledmap_1->setAnchorPoint(Vec2(0.5, 0.5));
    tmxtiledmap_1->setScaleY(1);
    tmxtiledmap_1->setScaleX(1);
    tmxtiledmap_1->setColor(Color3B(255, 255, 255));
    tmxtiledmap_1->setName("iso-test");
    tmxtiledmap_1->setLocalZOrder(0);
    tmxtiledmap_1->setGlobalZOrder(0);
    tmxtiledmap_1->setOpacity(255);
    tmxtiledmap_1->setOpacityModifyRGB(false);
    tmxtiledmap_1->setCascadeOpacityEnabled(true);
    tmxtiledmap_1->setSkewX(0);
    tmxtiledmap_1->setTag(-1);
    tmxtiledmap_1->setSkewY(0);
    tmxtiledmap_1->setRotationSkewY(0);
    tmxtiledmap_1->setPosition(Vec2(494, 231));
    tmxtiledmap_1->setRotationSkewX(0);
    scene_0->addChild(tmxtiledmap_1);
    // New node
    auto particlesystemquad_2 = ParticleSystemQuad::create("creator_assets/Galaxy.plist");
    particlesystemquad_2->setAnchorPoint(Vec2(0.5, 0.5));
    particlesystemquad_2->setScaleY(1);
    particlesystemquad_2->setScaleX(1);
    particlesystemquad_2->setColor(Color3B(255, 255, 255));
    particlesystemquad_2->setName("Galaxy");
    particlesystemquad_2->setLocalZOrder(0);
    particlesystemquad_2->setGlobalZOrder(0);
    particlesystemquad_2->setOpacity(255);
    particlesystemquad_2->setOpacityModifyRGB(false);
    particlesystemquad_2->setCascadeOpacityEnabled(true);
    particlesystemquad_2->setSkewX(0);
    particlesystemquad_2->setTag(-1);
    particlesystemquad_2->setContentSize(Size(0, 0));
    particlesystemquad_2->setSkewY(0);
    particlesystemquad_2->setRotationSkewY(0);
    particlesystemquad_2->setPosition(Vec2(115, 251));
    particlesystemquad_2->setRotationSkewX(0);
    scene_0->addChild(particlesystemquad_2);
    // New node
    auto sprite_3 = Sprite::create();
    sprite_3->setSpriteFrame("grossini_dance_08");
    sprite_3->setAnchorPoint(Vec2(0.5, 0.5));
    sprite_3->setScaleY(3);
    sprite_3->setScaleX(2);
    sprite_3->setColor(Color3B(255, 255, 255));
    sprite_3->setName("New Sprite (Splash)");
    ...
    sprite_3->setSkewX(0);
    sprite_3->setTag(-1);
    sprite_3->setContentSize(Size(85, 121));
    sprite_3->setSkewY(0);
    sprite_3->setRotationSkewY(0);
    sprite_3->setPosition(Vec2(263, 542));
    ...
    sprite_4->setSkewX(0);
    sprite_4->setTag(-1);
    sprite_4->setContentSize(Size(85, 121));
    sprite_4->setSkewY(0);
    sprite_4->setRotationSkewY(0);
    sprite_4->setPosition(Vec2(100, 407));
    sprite_4->setRotationSkewX(0);
    sprite_4->setCenterRectNormalized(Rect(0,0,1,1));
    scene_0->addChild(sprite_4);
    // New node
    auto label_5 = Label::createWithSystemFont("This is a label", "arial", 40);
    label_5->setAnchorPoint(Vec2(0.5, 0.5));
    label_5->setScaleY(1);
    label_5->setScaleX(1);
    label_5->setColor(Color3B(255, 255, 255));
    label_5->setName("Label_1");
    ...
    label_5->setHorizontalAlignment(TextHAlignment::CENTER);
    label_5->setSkewX(0);
    label_5->setTag(-1);
    label_5->setContentSize(Size(244.55, 40));
    label_5->setSkewY(0);
    label_5->setRotationSkewY(0);
    label_5->setPosition(Vec2(437, 606));
    label_5->setRotationSkewX(0);
    scene_0->addChild(label_5);
    // New node
    auto label_6 = Label::createWithSystemFont("This is another label", "arial", 40);
    label_6->setAnchorPoint(Vec2(0.5, 0.5));
    label_6->setScaleY(1);
    label_6->setScaleX(1);
    label_6->setColor(Color3B(255, 255, 255));
    label_6->setName("Label_2");
    ...
    label_6->setSkewX(0);
    label_6->setTag(-1);
    label_6->setContentSize(Size(357.97, 40));
    label_6->setSkewY(0);
    label_6->setRotationSkewY(0);
    label_6->setPosition(Vec2(107, 289));
    label_6->setRotationSkewX(0);
    scene_0->addChild(label_6);
    return scene_0;
}
////// AUTOGENERATED:END//////
