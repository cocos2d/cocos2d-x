...
Node* CreatorUI_create()
{
    ...
    scene_0_0->setTag(-1);
    // New node
    auto uieditbox_1_1 = ui::EditBox::create(Size(557,91), "creator_assets/default_progressbar");
    ...
    uieditbox_1_1->setInputMode(ui::EditBox::InputMode::SINGLE_LINE);
    ...
    uieditbox_1_1->setFontSize(48);
    uieditbox_1_1->setPlaceHolder("Enter text here...");
    uieditbox_1_1->setPosition(Vec2(309, 87));
    uieditbox_1_1->setReturnType(ui::EditBox::KeyboardReturnType::DEFAULT);
    uieditbox_1_1->setColor(Color3B(10, 0, 255));
    uieditbox_1_1->setInputFlag(ui::EditBox::InputFlag::INITIAL_CAPS_SENTENCE);
    uieditbox_1_1->setPlaceholderFontSize(48);
    uieditbox_1_1->setMaxLength(16);
    uieditbox_1_1->setTag(-1);
    uieditbox_1_1->setSkewX(0);
    uieditbox_1_1->setSkewY(0);
    scene_0_0->addChild(uieditbox_1_1);
    // New node
    auto uiloadingbar_1_2 = ui::LoadingBar::create();
    uiloadingbar_1_2->setAnchorPoint(Vec2(0.5, 0.5));
    uiloadingbar_1_2->setScaleY(1);
    uiloadingbar_1_2->setScaleX(1);
    uiloadingbar_1_2->setColor(Color3B(255, 255, 255));
    uiloadingbar_1_2->setName("progressBar");
    uiloadingbar_1_2->setPercent(50.0);
    uiloadingbar_1_2->setLocalZOrder(0);
    uiloadingbar_1_2->setGlobalZOrder(0);
    uiloadingbar_1_2->setOpacity(255);
    uiloadingbar_1_2->setOpacityModifyRGB(false);
    uiloadingbar_1_2->setCascadeOpacityEnabled(true);
    uiloadingbar_1_2->setTag(-1);
    uiloadingbar_1_2->setPosition(Vec2(689, 92));
    uiloadingbar_1_2->setSkewY(0);
    uiloadingbar_1_2->setRotationSkewY(0);
    uiloadingbar_1_2->setSkewX(0);
    uiloadingbar_1_2->setRotationSkewX(0);
    scene_0_0->addChild(uiloadingbar_1_2);
    // New node
    ...
    uiloadingbar_1_2->addChild(sprite_2_0);
    return scene_0_0;
}
////// AUTOGENERATED:END//////
