...
Node* CreatorUI_create()
{
    ...
    uiscrollview_7->getInnerContainer()->setAnchorPoint(Vec2(0.5,1));
    ...
    uiscrollview_7->getInnerContainer()->setPosition(Vec2(0,115.31));
    ...
    // New node
    auto label_8 = Label::createWithSystemFont("ScrollView content\n\n", "arial", 16);
    label_8->setAnchorPoint(Vec2(0, 1));
    label_8->setScaleY(1);
    label_8->setScaleX(1);
    label_8->setColor(Color3B(255, 255, 255));
    label_8->setName("item");
    label_8->setVerticalAlignment(TextVAlignment::TOP);
    label_8->setLocalZOrder(0);
    label_8->setGlobalZOrder(0);
    label_8->setOpacity(255);
    label_8->setOpacityModifyRGB(false);
    label_8->setCascadeOpacityEnabled(true);
    label_8->setHorizontalAlignment(TextHAlignment::CENTER);
    label_8->setSkewX(0);
    label_8->setTag(-1);
    label_8->setContentSize(Size(131.33, 60));
    label_8->setSkewY(0);
    label_8->setRotationSkewY(0);
    label_8->setPosition(Vec2(0, 0));
    label_8->setRotationSkewX(0);
    uiscrollview_7->addChild(label_8);
    // New node
    auto uibutton_9 = ui::Button::create("default_btn_normal", "", "", ui::Widget::TextureResType::PLIST);
    uibutton_9->setAnchorPoint(Vec2(0.5, 0.5));
    uibutton_9->setScaleY(1);
    uibutton_9->setScaleX(1);
    uibutton_9->setColor(Color3B(255, 255, 255));
    uibutton_9->setName("Button");
    uibutton_9->setLocalZOrder(0);
    uibutton_9->setGlobalZOrder(0);
    uibutton_9->setOpacity(255);
    uibutton_9->setOpacityModifyRGB(false);
    uibutton_9->setCascadeOpacityEnabled(true);
    uibutton_9->ignoreContentAdaptWithSize(false);
    uibutton_9->setSkewX(0);
    uibutton_9->setTag(-1);
    uibutton_9->setContentSize(Size(100, 40));
    uibutton_9->setSkewY(0);
    uibutton_9->setRotationSkewY(0);
    uibutton_9->setPosition(Vec2(0, 0));
    uibutton_9->setRotationSkewX(0);
    uiscrollview_7->addChild(uibutton_9);
    // New node
    auto label_10 = Label::createWithSystemFont("button", "arial", 20);
    label_10->setAnchorPoint(Vec2(0.5, 0.5));
    label_10->setScaleY(1);
    label_10->setScaleX(1);
    label_10->setColor(Color3B(0, 0, 0));
    label_10->setName("Label");
    label_10->setVerticalAlignment(TextVAlignment::CENTER);
    label_10->setLocalZOrder(0);
    label_10->setGlobalZOrder(0);
    label_10->setOpacity(255);
    label_10->setOpacityModifyRGB(false);
    label_10->setCascadeOpacityEnabled(true);
    label_10->setHorizontalAlignment(TextHAlignment::CENTER);
    label_10->setSkewX(0);
    label_10->setTag(-1);
    label_10->setContentSize(Size(100, 40));
    label_10->setSkewY(0);
    label_10->setRotationSkewY(0);
    label_10->setPosition(Vec2(0, 0));
    label_10->setRotationSkewX(0);
    uibutton_9->setTitleLabel(label_10);
    return scene_0;
}
////// AUTOGENERATED:END//////
