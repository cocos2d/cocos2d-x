	...
	, _sioEndpoint(nullptr)
{
    ...
    label->setPosition(Vector2(winSize.width / 2, winSize.height - MARGIN));
    addChild(label, 0);
    	
    auto menuRequest = Menu::create();
    menuRequest->setPosition(Vector2::ZERO);
	...
	itemSIOClient->setPosition(Vector2(VisibleRect::left().x + labelSIOClient->getContentSize().width / 2 + 5, winSize.height - MARGIN - SPACE));
	...
	itemSIOEndpoint->setPosition(Vector2(VisibleRect::right().x - labelSIOEndpoint->getContentSize().width / 2 - 5, winSize.height - MARGIN - SPACE));
    ...
    itemTestMessage->setPosition(Vector2(VisibleRect::left().x + labelTestMessage->getContentSize().width / 2 + 5, winSize.height - MARGIN - 2 * SPACE));
    ...
    itemTestMessageEndpoint->setPosition(Vector2(VisibleRect::right().x - labelTestMessageEndpoint->getContentSize().width / 2 - 5, winSize.height - MARGIN - 2 * SPACE));
    ...
    itemTestEvent->setPosition(Vector2(VisibleRect::left().x + labelTestEvent->getContentSize().width / 2 + 5, winSize.height - MARGIN - 3 * SPACE));
    ...
    itemTestEventEndpoint->setPosition(Vector2(VisibleRect::right().x - labelTestEventEndpoint->getContentSize().width / 2 - 5, winSize.height - MARGIN - 3 * SPACE));
    ...
    itemClientDisconnect->setPosition(Vector2(VisibleRect::left().x + labelTestClientDisconnect->getContentSize().width / 2 + 5, winSize.height - MARGIN - 4 * SPACE));
    ...
    itemTestEndpointDisconnect->setPosition(Vector2(VisibleRect::right().x - labelTestEndpointDisconnect->getContentSize().width / 2 - 5, winSize.height - MARGIN - 4 * SPACE));
    ...
    _sioClientStatus->setAnchorPoint(Vector2(0, 0));
    _sioClientStatus->setPosition(Vector2(VisibleRect::left().x, VisibleRect::rightBottom().y));
