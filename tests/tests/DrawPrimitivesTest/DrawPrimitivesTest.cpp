...
void DrawPrimitivesTest::draw()
{
	...
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glDisable(GL_LINE_SMOOTH);
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glLineWidth( 5.0f );
	/*glColor4ub(255,0,0,255);*/
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(1.0, 0.0, 0.0, 1.0);
	...
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glPointSize(64);
	/*glColor4ub(0,0,255,128);*/
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(0.0, 0.0, 1.0, 0.5);
	...
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glPointSize(4);
	/*glColor4ub(0,255,255,255);*/
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(0.0, 1.0, 1.0, 1.0);
	ccDrawPoints( points, 4);
	
	// draw a green circle with 10 segments
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glLineWidth(16);
	/*glColor4ub(0, 255, 0, 255);*/
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(0.0, 1.0, 0.0, 1.0);
	ccDrawCircle( CCPointMake(s.width/2,  s.height/2), 100, 0, 10, false);

	// draw a green circle with 50 segments with line to center
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glLineWidth(2);
	/*glColor4ub(0, 255, 255, 255);*/
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(0.0, 1.0, 1.0, 1.0);
	...
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(1.0, 1.0, 0.0, 1.0);
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glLineWidth(10);
	CCPoint vertices[] = { CCPointMake(0,0), CCPointMake(50,50), CCPointMake(100,50), CCPointMake(100,100), CCPointMake(50,100) };
	ccDrawPoly( vertices, 5, false);
	
	// closed purble poly
	/*glColor4ub(255, 0, 255, 255);*/
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(1.0, 0.0, 1.0, 1.0);
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glLineWidth(2);
	...
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glColor4f(1.0, 1.0, 1.0, 1.0);
	cocos2d::CCDirector::sharedDirector()->getGLContext()->glPointSize(1); 
}
