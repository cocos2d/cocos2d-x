...
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG,"OPENSL.CPP", __VA_ARGS__)
 ...
 *   background music
 **********************************************************************************/
bool OpenSL::preloadBackgroundMusic(const char * filename)
{
...
void OpenSL::setBackgroundMusicState(int state)
{
	SLresult result;
...
int OpenSL::getBackgroundMusicState()
{
	SLresult result;
	SLuint32 state;
	if (musicPlayer.fdPlayerPlay != NULL)
...
void OpenSL::rewindBackgroundMusic()
{
	SLresult result;
...
void OpenSL::setBackgroundMusicLooping(bool isLooping)
{
    SLresult result;
...
void OpenSL::setBackgroundVolume(int volume)
{
...
int OpenSL::getBackgroundVolume()
{
...
unsigned int OpenSL::preloadEffect(const char * filename)
{
...
void OpenSL::unloadEffect(const char * filename)
{
	unsigned int nID = _Hash(filename);
...
void OpenSL::setEffectState(unsigned int effectID, int state)
{
...
void OpenSL::setAllEffectState(int state)
{
...
void OpenSL::setEffectLooping(unsigned int effectID, bool isLooping)
{
	SLresult result;
...
void OpenSL::setEffectsVolume(int volume)
{
