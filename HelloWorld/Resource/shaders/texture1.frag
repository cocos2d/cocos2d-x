...
{	
#if TEXTURE1_ENV_MODE == OGL_MODULATE
	#if TEXTURE1_FORMAT == OGL_ALPHA
		color.a = color.a * texture1Color.a;
	#elif TEXTURE1_FORMAT == OGL_LUMINANCE
		color.rgb = color.rgb * texture1Color.rgb;
	#elif TEXTURE1_FORMAT == OGL_LUMINANCE_ALPHA
		color = color * texture1Color.rgb;
	#elif TEXTURE1_FORMAT == OGL_RGB
		color.rgb = color.rgb * texture1Color.rgb;
	#elif TEXTURE1_FORMAT == OGL_RGBA
		color = color * texture1Color;
	#endif
#elif TEXTURE1_ENV_MODE == OGL_ADD
	#if TEXTURE1_FORMAT == OGL_ALPHA
		color.a = color.a * texture1Color.a;
	#elif TEXTURE1_FORMAT == OGL_LUMINANCE
		color.rgb = color.rgb + texture1Color.rgb;
		...
		color.a = color.a * texture1Color.a;
	#endif
#elif TEXTURE1_ENV_MODE == OGL_DECAL
	#if TEXTURE1_FORMAT == OGL_ALPHA
	#elif TEXTURE1_FORMAT == OGL_LUMINANCE
	#elif TEXTURE1_FORMAT == OGL_LUMINANCE_ALPHA
	#elif TEXTURE1_FORMAT == OGL_RGB
	...
	#endif
#elif TEXTURE1_ENV_MODE == OGL_BLEND
	#if TEXTURE1_FORMAT == OGL_ALPHA
		color.a = color.a * texture1Color.a;
	#elif TEXTURE1_FORMAT == OGL_LUMINANCE
		...
		color.a = color.a * texture1Color.a;
	#endif
#elif TEXTURE1_ENV_MODE == OGL_REPLACE
	#if TEXTURE1_FORMAT == OGL_ALPHA
		...
		color = texture1Color;
	#endif
#elif TEXTURE1_ENV_MODE == OGL_BLUR
...
#elif TEXTURE1_ENV_MODE == OGL_COMBINE
	vec4 arg0;
	vec4 arg1;
	vec4 arg2;
	...
	#elif TEXTURE1_ENV_SRC0_RGB == OGL_CONSTANT
		arg0.rgb = u_texture1EnvColor.rgb;
	#elif TEXTURE1_ENV_SRC0_RGB == OGL_PRIMARY_COLOR
		arg0.rgb = v_frontColor.rgb;
	#elif TEXTURE1_ENV_SRC0_RGB == OGL_PREVIOUS
		arg0.rgb = color.rgb;
	#endif

	#if TEXTURE1_ENV_OPERAND0_RGB == OGL_ONE_MINUS_SRC_COLOR
	...
	#elif TEXTURE1_ENV_SRC1_RGB == OGL_CONSTANT
		arg1.rgb = u_texture1EnvColor.rgb;
	#elif TEXTURE1_ENV_SRC1_RGB == OGL_PRIMARY_COLOR
		arg1.rgb = v_frontColor.rgb;
	#elif TEXTURE1_ENV_SRC1_RGB == OGL_PREVIOUS
		arg1.rgb = color.rgb;
	#endif
	...
	#elif TEXTURE1_ENV_SRC2_RGB == OGL_CONSTANT
		arg2.rgb = u_texture1EnvColor.rgb;
	#elif TEXTURE1_ENV_SRC2_RGB == OGL_PRIMARY_COLOR
		arg2.rgb = v_frontColor.rgb;
	#elif TEXTURE1_ENV_SRC2_RGB == OGL_PREVIOUS
		arg2.rgb = color.rgb;
	#endif
		
	#if TEXTURE1_ENV_OPERAND2_RGB == OGL_ONE_MINUS_SRC_COLOR
	...
	#elif TEXTURE1_ENV_SRC0_ALPHA == OGL_CONSTANT
		arg0.a = u_texture1EnvColor.a;
	#elif TEXTURE1_ENV_SRC0_ALPHA == OGL_PRIMARY_COLOR
		arg0.a = v_frontColor.a;
	#elif TEXTURE1_ENV_SRC0_ALPHA == OGL_PREVIOUS
		arg0.a = color.a;
	#endif
		
	#if TEXTURE1_ENV_OPERAND0_ALPHA == OGL_ONE_MINUS_SRC_ALPHA
		arg0.a = 1.0 - arg0.a;
	#endif
	...
	#elif TEXTURE1_ENV_SRC1_ALPHA == OGL_CONSTANT
		arg1.a = u_texture1EnvColor.a;
	#elif TEXTURE1_ENV_SRC1_ALPHA == OGL_PRIMARY_COLOR
		arg1.a = v_frontColor.a;
	#elif TEXTURE1_ENV_SRC1_ALPHA == OGL_PREVIOUS
		arg1.a = color.a;
	#endif
	...
	#elif TEXTURE1_ENV_SRC2_ALPHA == OGL_CONSTANT
		arg2.a = u_texture1EnvColor.a;
	#elif TEXTURE1_ENV_SRC2_ALPHA == OGL_PRIMARY_COLOR
		arg2.a = v_frontColor.a;
	#elif TEXTURE1_ENV_SRC2_ALPHA == OGL_PREVIOUS
		arg2.a = color.a;
	#endif
		
	#if TEXTURE1_ENV_OPERAND2_ALPHA == OGL_ONE_MINUS_SRC_ALPHA
		arg2.a = 1.0 - arg2.a;
	#endif
		
	#if TEXTURE1_ENV_COMBINE_RGB == OGL_REPLACE
		color.rgb = arg0.rgb;
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_MODULATE
		color.rgb = arg0.rgb * arg1.rgb;
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_ADD
		color.rgb = arg0.rgb + arg1.rgb;
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_ADD_SIGNED
		color.rgb = arg0.rgb + arg1.rgb - 0.5;
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_INTERPOLATE
		color.rgb = mix(arg1.rgb, arg0.rgb, arg2.rgb);
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_SUBTRACT
		color.rgb = arg0.rgb - arg1.rgb;
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_DOT3_RGB
		color.r = 4.0*((arg0.r - 0.5)*(arg1.r - 0.5) + (arg0.g - 0.5)*(arg1.g - 0.5) + (arg0.b - 0.5)*(arg1.b - 0.5));
		color.g = color.r;
		color.b = color.r;
	#elif TEXTURE1_ENV_COMBINE_RGB == OGL_DOT3_RGBA
		color.r = 4.0*((arg0.r - 0.5)*(arg1.r - 0.5) + (arg0.g - 0.5)*(arg1.g - 0.5) + (arg0.b - 0.5)*(arg1.b - 0.5));
		color.g = color.r;
		color.b = color.r;
		color.a = color.r;
	...
	#if TEXTURE1_ENV_COMBINE_ALPHA == OGL_REPLACE
		color.a = arg0.a;
	#elif TEXTURE1_ENV_COMBINE_ALPHA == OGL_MODULATE
		color.a = arg0.a * arg1.a;
	#elif TEXTURE1_ENV_COMBINE_ALPHA == OGL_ADD
		color.a = arg0.a + arg1.a;
	#elif TEXTURE1_ENV_COMBINE_ALPHA == OGL_ADD_SIGNED
		color.a = arg0.a + arg1.a - 0.5;
	#elif TEXTURE1_ENV_COMBINE_ALPHA == OGL_INTERPOLATE
		color.a = mix(arg1.a, arg0.a, arg2.a);
	#elif TEXTURE1_ENV_COMBINE_ALPHA == OGL_SUBTRACT
		color.a = arg0.a - arg1.a;
	#endif
#endif
