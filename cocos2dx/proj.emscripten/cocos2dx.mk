...
ifeq ($(DEBUG), 1)
CCFLAGS += -O0 -s ASSERTIONS=1 --jcache -s GL_UNSAFE_OPTS=0  # -s SAFE_HEAP=1 As of 2013-23-07 this options causes a segfault
CXXFLAGS += -O0 -s ASSERTIONS=1 --jcache -s GL_UNSAFE_OPTS=0 # -s SAFE_HEAP=1 As of 2013-23-07 this options causes a segfault
